...
export default function NewsLetter({
  ...
  subtitle = "Be the first to know about new hygiene products, baby & adult care, and exclusive offers from Anandavrinda.",
  buttonText = "Subscribe",
  placeholder = "Your email address",
  successTitle = "Welcome to the Anandavrinda Family",
